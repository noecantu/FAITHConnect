...
export async function POST(req: Request) {
  try {
    ...
    if (body.memberId !== undefined) updatePayload.member_id = body.memberId;
    if (body.memberName !== undefined) updatePayload.member_name = body.memberName;
    if (body.amount !== undefined) updatePayload.amount = body.amount;
    if (body.category !== undefined) updatePayload.category = body.category;
    if (body.contributionType !== undefined) updatePayload.contribution_type = body.contributionType;
