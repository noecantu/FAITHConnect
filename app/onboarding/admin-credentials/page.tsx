...
export default function AdminCredentialsPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 1. Sign up — Supabase creates the auth.users row and sets the session cookie
      ...
      // 2. Create profile record in public.users
      ...
      toast({ title: "Signup Failed", description: "Unable to create your account." });
    } finally {
      setIsLoading(false);
    }
  };
