...
export function usePermissions() {
  ...
  return {
    ...
    canManageSetlists: can(roles, "setlists.manage", grants),
    canReadSetlists: can(roles, "setlists.read", grants),
    canManageSongs: can(roles, "songs.manage", grants),
    canReadSongs: can(roles, "songs.read", grants),
